  ...
  private createFormUser(user: User): void {
    this.formUser = this.formBuilder.group({
      ...
      passwordForm: this.formBuilder.group({
        password: [user.passwordForm.password, [Validators.required, Validators.minLength(6)]],
        confirm: [user.passwordForm.confirm, [Validators.required, Validators.minLength(6)]],
      }, {
  ...
  getErrorMessage(inputName: string) {
    ...
    switch (inputName) {
      ...
      case 'password':
        ...
        return this.formUser.get(inputName).hasError('minlength') ? 'Mínimo de 6 caracteres' : '';
    }
